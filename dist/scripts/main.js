...
function setupSettingDialog(reset) {
...
function getElements() {
    ...
    const nInputs = [document.querySelector('#inumber1'),
        document.querySelector('#inumber2'),
        document.querySelector('#inumber3')];
    const nDispalys = [document.querySelector('#inumber1d'),
        document.querySelector('#inumber2d'),
        document.querySelector('#inumber3d')];
...
function setTakeNumberMethod(n) {
    document.querySelectorAll('[takeNumberMethod]').forEach(tme => {
...
function runTakeNumber(takeNumberMethod, elements, viewContainer) {
